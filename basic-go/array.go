...
func main() {
	...
	*/
	...
	var valuess = [...]int{
		/*
			[...] tanda ini adalah untuk menampung berapa banyak array yang ingin dimasukkan, jadi jika kita tidak tau ingin memasukkan jumlah data array nya berapa maka buat saja tanda itu
	...
	valuess[0] = 100
	// format valuess[0] = 100 => valuess adalah array, [0] ini = index, 100 adalah value
	fmt.Println(valuess)
